...
const ui: PetWaterIntakeUI = {
  ...
  instantHint: 'Jede Option passt den Wasserstand sofort an. Es handelt sich um eine Richtlinie.',
  unitLegend: 'Einheiten',
  metricUnit: 'Metrisch',
  imperialUnit: 'Imperial',
  speciesLegend: 'Für wen ist der Wassernapf?',
  speciesDog: 'Hund',
  speciesCat: 'Katze',
  speciesDogMeta: 'Richtwert 60 mL pro kg',
  speciesCatMeta: 'Richtwert 40 mL pro kg',
  ...
  dietDryMeta: 'Der Großteil des Wassers wird getrunken',
  dietMixed: 'Mischfütterung',
  dietMixedMeta: 'Ein Teil des Wassers stammt aus den Mahlzeiten',
  dietWet: 'Überwiegend Nassfutter',
  dietWetMeta: 'Nassfutter liefert einen großen Teil der Feuchtigkeit',
  ...
  sceneBowl: 'Mitte des täglichen Bereichs',
  methodTitle: 'Berechnungsmethode',
  methodText: 'Basiert auf den AAHA-Richtwerten von 60 mL/kg für Hunde und 40 mL/kg für Katzen mit Anpassung an Futter und Wetter.',
  ...
  invalidWeight: 'Bitte geben Sie ein gültiges Körpergewicht ein.',
  weightRange: 'Das Gewicht muss zwischen 0.5 kg und 100 kg liegen.',
};
