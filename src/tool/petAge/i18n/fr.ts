...
const ui: PetAgeUI = {
  ...
  stageDogTeen: 'Adolescence Rebelle',
  stageDogAdult: 'Âge Adulte',
  stageDogMature: 'Maturité Distinguée',
  stageDogSenior: 'Sagesse Senior',
  stageCatKitten: 'Curiosité Enfantine',
  stageCatYouth: 'Jeunesse Féline',
  stageCatReign: 'Règne Domestique',
  stageCatVeteran: 'Vétéran Choyé',
  stageCatVenerable: 'Félin Vénérable',
};
